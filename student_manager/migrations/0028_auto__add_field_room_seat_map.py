...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'student_manager_room', 'seat_map',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'student_manager_room', 'seat_map')
    ...
    models = {
        u'student_manager.entrytest': {
            ...
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['student_manager.Student']", 'unique': 'True'})
        },
