...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.obscured_matrikel'
        db.add_column('student_manager_student', 'obscured_matrikel',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.obscured_matrikel'
        db.delete_column('student_manager_student', 'obscured_matrikel')
