...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table('student_manager_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('time', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('assistent', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('student_manager', ['Group'])


    def backwards(self, orm):
        # Deleting model 'Group'
        db.delete_table('student_manager_group')
