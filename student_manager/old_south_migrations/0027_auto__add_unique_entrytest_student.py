...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EntryTest', fields ['student']
        db.create_unique('student_manager_entrytest', ['student_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntryTest', fields ['student']
        db.delete_unique('student_manager_entrytest', ['student_id'])
