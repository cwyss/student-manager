...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.modulo_matrikel'
        db.add_column('student_manager_student', 'modulo_matrikel',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.modulo_matrikel'
        db.delete_column('student_manager_student', 'modulo_matrikel')
