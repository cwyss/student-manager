...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Room.first_seat'
        db.add_column(u'student_manager_room', 'first_seat',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Room.first_seat'
        db.delete_column(u'student_manager_room', 'first_seat')
