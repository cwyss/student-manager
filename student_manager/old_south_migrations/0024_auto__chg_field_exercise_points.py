...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exercise.points'
        db.alter_column('student_manager_exercise', 'points', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Exercise.points'
        db.alter_column('student_manager_exercise', 'points', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))
