...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MasterExam.num_exercises'
        db.add_column('student_manager_masterexam', 'num_exercises',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MasterExam.num_exercises'
        db.delete_column('student_manager_masterexam', 'num_exercises')
