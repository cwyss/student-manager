...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Room.seat_map'
        db.add_column('student_manager_room', 'seat_map',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Room.seat_map'
        db.delete_column('student_manager_room', 'seat_map')


    models = {
        'student_manager.entrytest': {
            'Meta': {'ordering': "('student',)", 'object_name': 'EntryTest'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student_manager.Student']", 'unique': 'True'})
        },
        ...
        'student_manager.room': {
            ...
            'priority': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'seat_map': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
