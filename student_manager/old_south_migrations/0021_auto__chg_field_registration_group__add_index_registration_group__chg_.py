...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Registration.group' to match new field type.
        db.rename_column('student_manager_registration', 'group', 'group_id')
        # Changing field 'Registration.group'
        db.alter_column('student_manager_registration', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student_manager.Group']))
        # Adding index on 'Registration', fields ['group']
        # db.create_index('student_manager_registration', ['group_id'])


        # Renaming column for 'Exercise.group' to match new field type.
        db.rename_column('student_manager_exercise', 'group', 'group_id')
        # Changing field 'Exercise.group'
        db.alter_column('student_manager_exercise', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student_manager.Group'], null=True))
        # Adding index on 'Exercise', fields ['group']
        # db.create_index('student_manager_exercise', ['group_id'])


    def backwards(self, orm):
        # Removing index on 'Exercise', fields ['group']
        # db.delete_index('student_manager_exercise', ['group_id'])

        # Removing index on 'Registration', fields ['group']
        # db.delete_index('student_manager_registration', ['group_id'])


        # Renaming column for 'Registration.group' to match new field type.
        db.rename_column('student_manager_registration', 'group_id', 'group')
        # Changing field 'Registration.group'
        db.alter_column('student_manager_registration', 'group', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Exercise.group' to match new field type.
        db.rename_column('student_manager_exercise', 'group_id', 'group')
        # Changing field 'Exercise.group'
        db.alter_column('student_manager_exercise', 'group', self.gf('django.db.models.fields.IntegerField')(null=True))
